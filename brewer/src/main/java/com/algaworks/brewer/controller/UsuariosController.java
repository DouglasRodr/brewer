...
public class UsuariosController {
	...
	public ModelAndView pesquisar(UsuarioFilter usuarioFilter
		...
		PageWrapper<Usuario> paginaWrapper = new PageWrapper<>(cadastroUsuarioService.filtrarComGrupos(usuarioFilter, pageable)
				, httpServletRequest);
	...
	public ModelAndView editar(@PathVariable Long codigo) {
		Usuario usuario = usuarios.buscar(codigo);
